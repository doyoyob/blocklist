...
# But not sure will it work with Pi-Hole 5.0
#================================================================================
TICK="[\e[32m ✔ \e[0m]"
...
curl -sS https://github.com/doyoyob/blocklist/raw/master/whitelist | sudo tee -a "${PIHOLE_LOCATION}"/whitelist.txt >/dev/null
